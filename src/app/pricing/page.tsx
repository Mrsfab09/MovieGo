        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={classNames(
              tier.featured
                ...
                : "bg-slate-300/10 sm:mx-8 lg:mx-0",
              tier.featured
                ? ""
                : tierIdx === 0
          ...
          >
            ...
            <a
              ...
              className={classNames(
                tier.featured
                  ? "bg-[#ff433d]/90 text-white shadow-sm hover:bg-indigo-400 focus-visible:outline-indigo-500"
                  : "text-rose-600 ring-1 ring-inset ring-indigo-200 hover:ring-indigo-300 focus-visible:outline-indigo-600",
